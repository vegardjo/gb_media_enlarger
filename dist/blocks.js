...
/***/ "./blocks/media_enlarger/index.js":
/*!****************************************!*\
  !*** ./blocks/media_enlarger/index.js ***!
  \****************************************/
...
const alterMediaBlock = (settings, name) => {
  ...
  const newEdit = props => {
    ...
    const [isExpandable, setIsExpandable] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(attributes.isExpandable || false);
    const toggleButton = () => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (alterMediaBlock);
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _media_enlarger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./media_enlarger */ "./blocks/media_enlarger/index.js");
const {
  addFilter
} = wp.hooks;

addFilter('blocks.registerBlockType', 'utils/mediaEnlarger', _media_enlarger__WEBPACK_IMPORTED_MODULE_0__["default"]);
})();
